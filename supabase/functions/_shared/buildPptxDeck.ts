...
function addTitleSlide(pptx: any, spec: any) {
  ...
  slide.addText(spec.modelTitle || 'Presentation', {
    ...
    fontSize: 36, bold: true, color: COLORS.ink, fontFace: FONT_HEADING,
  });
...
function addSectionSlide(pptx: any, title: string) {
  ...
  slide.addText(title, {
    ...
    fontSize: 32, bold: true, color: COLORS.white, fontFace: FONT_HEADING,
  });
...
function addBulletSlide(pptx: any, title: string, bullets: string[]) {
  ...
  slide.addText(title, {
    ...
    fontSize: 24, bold: true, color: COLORS.ink, fontFace: FONT_HEADING,
    valign: 'middle',
  });
...
export async function buildPptxDeck(spec: any): Promise<Uint8Array> {
  ...
  closingSlide.addText('Thank you', {
    ...
    fontSize: 36, bold: true, color: COLORS.white, fontFace: FONT_HEADING,
    align: 'center',
  });
