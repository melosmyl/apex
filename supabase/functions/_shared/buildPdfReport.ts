...
// jsPDF only ships the standard PDF fonts, so the brand typefaces cannot be
// used here without embedding TTFs; Helvetica stands in for Inter.
const COLORS = {
  ink: [23, 25, 28],
  sub: [122, 122, 113],
  accent: [179, 135, 25],
