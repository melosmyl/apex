  ...
  return (
    <div>
      ...
      {items === null ? <div className="h-40 rounded-2xl bg-secondary/60 animate-pulse" />
        : items.length === 0 ? <EmptyState icon={CheckSquare} title="No tasks yet" description="Create a task, or let your board assign work during a meeting." action={<Button onClick={() => setOpen(true)} variant="primary" className="px-6"><Plus className="w-4 h-4 mr-1.5" /> New task</Button>} />
        : (
