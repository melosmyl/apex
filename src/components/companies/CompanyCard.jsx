...
export default function CompanyCard({ company, stats, advisors = [] }) {
  ...
  return (
    <button
      ...
      className="group text-left bg-card border border-border/70 rounded-2xl p-5 sm:p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 flex flex-col h-full">
