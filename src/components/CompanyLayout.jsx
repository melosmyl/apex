...
import {
  ...
  FileText, Search, Scale, CalendarClock, Settings, ChevronLeft, Menu, X
} from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      <div className="px-6 py-6 border-b border-border/60">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-primary text-primary-foreground flex items-center justify-center font-display text-lg overflow-hidden">
