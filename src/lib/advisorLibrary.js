...
export const ADVISOR_PROVIDER_CONFIG = {
  ...
  operator: { default_provider: "openai", default_model: "gpt-4o", fallback_provider: "anthropic", fallback_model: "claude-sonnet-5", temperature: 0.5, maximum_output_length: 2000, is_premium: false, system_instructions: "Focus on feasibility, sequencing, suppliers, staffing, cost, timelines, quality control and execution risk. Convert broad recommendations into specific actions. Identify bottlenecks and dependencies." },
  ...
  contrarian: { default_provider: "openai", default_model: "gpt-4o", fallback_provider: "anthropic", fallback_model: "claude-sonnet-5", temperature: 0.5, maximum_output_length: 2000, is_premium: false, system_instructions: "Challenge the strongest argument rather than disagreeing for theatrical effect. Identify hidden assumptions, second-order consequences and plausible alternative explanations. Be direct but constructive." },
  ...
  scientist: { default_provider: "openai", default_model: "gpt-4o", fallback_provider: "anthropic", fallback_model: "claude-sonnet-5", temperature: 0.5, maximum_output_length: 2000, is_premium: true, system_instructions: "Ground decisions in evidence and first principles. Identify what is known, unknown and untested. Recommend experiments." },
  supply_chain: { default_provider: "openai", default_model: "gpt-4o", fallback_provider: "anthropic", fallback_model: "claude-sonnet-5", temperature: 0.4, maximum_output_length: 2000, is_premium: false, system_instructions: "Assess sourcing, logistics, manufacturing, resilience and cost. Identify supply chain risks and dependencies." },
